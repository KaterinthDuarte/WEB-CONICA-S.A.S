...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <link href="<?php echo BASE_URL; ?>public/img/pe.png" rel="shortcut icon">
...
<body>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                          <!-- ?php echo BASE_URL; ?     hace que todos tengan la misma imagen en el logo -->
                    <a href="<?php echo BASE_URL; ?>CONICA1/index.html">
                    <img src="<?php echo BASE_URL; ?>public/img/logo.png" alt="LOGO" width="50"></a>
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <!-- final cabeza o header-->

    <!-- seccion hero (lado izquierdo a mirar)-->
                    ...
                    <?php if ($data['title'] == 'Pagina Principal') { ?>
                        <div class="hero__item set-bg" data-setbg="<?php echo BASE_URL; ?>public/img/hero/banner.jpg">
                            <div class="hero__text">
                                <span>Comida organica para <br>animales de granja</span>
                                <h2>100% Organica</h2>
                                <p>Recogida y entrega a domicilio</p>
