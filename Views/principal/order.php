...
<section class="shoping-cart spad">
    <div class="container">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-5">Iniciar sesión</h5>
                <div class="card">
                    <div class="card-body">
                        <div class="form-structor">
                            ...
                            <div class="login slide-up">
                                <div class="center">
                                    <h2 class="form-title" id="loginForm"><span>or</span>Iniciar sesión</h2>
                                    <div class="form-holder mb-3">
                                        <input type="email" id="email" class="input" placeholder="Email" />
                                        <input type="password" id="password" class="input" placeholder="Password" />
                                    </div>
                                    <a href="<?php echo BASE_URL . 'principal/recoverpw'; ?>">Olvidaste tu contraseña?</a>
                                    <button class="submit-btn" id="btnLogin">Iniciar sesión</button>
                                </div>
                            </div>
                        </div>
                    </div>
