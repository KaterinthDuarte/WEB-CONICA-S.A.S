                            ...
                            <div class="p-2">
                                <form class="form-horizontal m-t-20" id="formulario" autocomplete="off">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <input class="form-control" id="email" name="email" type="text" required="" value="" placeholder="Usuario">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <div class="col-12">
                                            <input class="form-control" id="clave" name="clave" type="password" required="" value="" placeholder="Password">
                                        </div>
                                    </div>
