  ...
  botonwhatsapp.addEventListener("click", function (e) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.open(
          `https://api.whatsapp.com/send?phone=${whatsapp_negocio.value}&text=Buen dia, estoy interesad@ en los siguientes productos: ${productosWhatsapp} === Precio total(${productosTotal}) iva incluido`,
          "_blank"
        );
      }
    });
